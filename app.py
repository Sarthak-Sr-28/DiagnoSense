...
diabetes_model = pickle.load(open("E:\DiagnoSense\Saved Models\diabetes_model.sav", 'rb'))

heart_disease_model = pickle.load(open("E:\DiagnoSense\Saved Models\heart_disease_model.sav", 'rb'))

parkinsons_model = pickle.load(open("E:\DiagnoSense\Saved Models\parkinson_disease_model.sav", 'rb'))
    ...
    if st.button('Diabetes Test Result'):
        try:
            ...
            if None in [Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age]:
                ...
                sc = pickle.load(open("E:\DiagnoSense\Saved Scalers\diabetes_scaler.pkl", 'rb'))
                qt = pickle.load(open("E:\DiagnoSense\Saved Quantile Transformer\diabetes_quantile.pkl", 'rb'))
    ...
    if st.button('Heart Disease Test Result'):
        try:
            if None in [age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal]:
                ...
                # Load scaler and quantile transformer
                sc = pickle.load(open("E:\DiagnoSense\Saved Scalers\heart_scaler.pkl", 'rb'))
                qt = pickle.load(open("E:\DiagnoSense\Saved Quantile Transformer\heart_quantile.pkl", 'rb'))
...
if selected == "Parkinsons Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        try:
            ...
            # Load scaler and quantile transformer
            sc = pickle.load(open("E:\DiagnoSense\Saved Scalers\parkinson_scaler.pkl", 'rb'))
            qt = pickle.load(open("E:\DiagnoSense\Saved Quantile Transformer\parkinson_quantile.pkl", 'rb'))
